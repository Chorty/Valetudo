...
- **SSH**: `sshpass -p '<REDACTED_HOME_ASSISTANT_SSH_PASSWORD>' ssh -o StrictHostKeyChecking=no -o PreferredAuthentications=password -o PubkeyAuthentication=no -o IdentitiesOnly=yes -p 2224 hassio@192.168.1.106`
